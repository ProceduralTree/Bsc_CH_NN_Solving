...
#+begin_src python :results file link  :file phase.png :session
test_phase = tu.k_squares_phase(10, 5)
plt.figure()
...
#+begin_src python :results file link :file it_40.png :session :async
solver = tu.setup_solver(test_phase)
solver.solve(40,10)
plt.figure()
sns.heatmap(solver.phase_small)
plt.savefig("it_40.png")
#+end_src
